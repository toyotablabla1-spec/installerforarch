...
yay -Syyu --noconfirm linux-zen linux-lts firefox wofi thunar flatpak discord grub base-devel hyprland nyancat kitty vlc neovim git htop cava cmatrix fastfetch git python docker gimp chromium steam blackarch blackarch-wireless blackarch-webapp libcaca plymouth-kcm plasma-desktop htop btop gtop procps-ng file wine nsnake
