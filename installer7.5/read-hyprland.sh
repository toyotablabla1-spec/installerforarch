echo "1 = archlinux 5 minut from https://www.youtube.com/watch?v=azGR2P5aco0"
echo "2 = hyde
   ▄▄▄▄▄▄▄
 ▄█████▒▒▒▓▄
 █████▒▒▓▓▓█
